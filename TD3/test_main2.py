...
from sumocfg import generate_mix_rou_file
from sumocfg import generate_mix_cfg_file
...
def eval():
    ...
    for i_ep in range(cfg.eval_eps):
        ...
        generate_mix_rou_file(train_eps = i_ep + 1, cav_penetration=0.25,  path="mix_rou_net")    #######
        generate_mix_cfg_file(train_eps= i_ep + 1)    #######

        cfg_file_name = 'mix_rou_net/intersection' + str(i_ep + 1) + '.sumocfg'
